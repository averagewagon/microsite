...
Right now, all the web resources are served directly from the ESP32-S3's flash
memory. Reading from flash memory is slow, and I have 8 MB of PSRAM available
which I can use to implement a cache.
